...
class AppPilchero(tk.Tk):
    ...
    def mostrar_centro_ia(self):
        ...
        # Registrar estos elementos (guardar refs de widgets + ids)
        widgets.extend([header_frame, header_window_id, frame_nav, nav_window_id, shadow_frame, shadow_window_id])
        # Bajar el item de sombra en el canvas usando su ID (no el widget)
        try:
            self.canvas_bg.tag_lower(shadow_window_id)
        except Exception:
            pass
        ...
        for i, (text, action, bg_color, hover_color) in enumerate(nav_buttons):
            ...
            btn = tk.Button(frame_nav, 
                           ...
                           pady=8,
                           padx=12)
            btn.place(x=x_pos, y=22, width=button_width, height=35)
        ...
        content_frame = tk.Frame(self.canvas_bg, bg="#1155f4", relief="flat", bd=1)
        ...
        # Asegurar orden correcto: navegación arriba de la sombra y contenido encima
        try:
            self.canvas_bg.tag_raise(nav_window_id)
            self.canvas_bg.tag_raise(content_window_id)
        except Exception:
            pass

    def mostrar_cierre_caja(self):
        print("[DEBUG] mostrar_cierre_caja() llamado - main.py:3129")
        self.limpiar_pantalla()
        self._colocar_logo(pantalla_principal=False)
        self._chip_volver(self.mostrar_menu_principal)
    ...
    def mostrar_alta_producto(self):
        print("[DEBUG] mostrar_alta_producto() llamado - main.py:3136")
        if not self.require_role(["admin"]):
            return
        self.limpiar_pantalla()
        self._colocar_logo(pantalla_principal=False)
    ...
    def _pantalla_venta(self, parent):
        ...
        # Eliminamos precios para no mostrar precios de costo
        ...
        # Eliminar diccionario de precios para no mostrar precios de costo
        ...
        def on_keyrelease(event):
            ...
            def filtrar_opciones():
                try:
                    ...
                    print(f"[DEBUG] Error en filtrado: {e} - main.py:3268")
        ...
        def on_combobox_select(event):
            ...
            if seleccion and seleccion in productos_dict:
                ...
                print(f"[DEBUG] Producto seleccionado: {seleccion}  on_combobox_select - main.py:3282")
        ...
        def set_precio_venta(event=None):
            ...
            print(f"[DEBUG] set_precio_venta llamado para: '{seleccion}'  set_precio_venta - main.py:3485")
            ...
            if seleccion in productos_dict:
                ...
                print(f"[DEBUG] Producto encontrado: {producto.marca} {producto.descripcion}  Stock: {producto.cantidad}  set_precio_venta - main.py:3493")
                ...
                if producto.oferta and producto.oferta.get('tipo'):
                    print(f"[DEBUG] Oferta encontrada: {producto.oferta}  set_precio_venta - main.py:3509")
                ...
                print(f"[DEBUG] Precio cargado: {precio_mostrar}{mensaje_oferta}  set_precio_venta - main.py:3528")
            else:
                print(f"[DEBUG] Producto no encontrado en diccionario  set_precio_venta - main.py:3530")
                precio_var.set("")
    ...
    def _crear_panel_gastos(self):
        ...
        print("[DEBUG] Iniciando creación del panel de gastos  _crear_panel_gastos - main.py:3865")
        widgets = []
        hoy = datetime.date.today()
        gastos_hoy = self.sistema.obtener_gastos_fecha(hoy)
        print(f"[DEBUG] Gastos encontrados para hoy ({hoy}): {len(gastos_hoy)} gastos  _crear_panel_gastos - main.py:3869")
    ...
    def _agregar_gasto_dia(self):
        ...
        try:
            ...
            print(f"[DEBUG] Error en _agregar_gasto_dia: {e} - main.py:4030")

    def _actualizar_lista_gastos(self):
        """Actualiza la lista visual de gastos con formato vertical"""
        print("[DEBUG] Actualizando lista visual de gastos - main.py:4034")
    ...
    def _actualizar_panel_gastos(self):
        ...
        print("[DEBUG] Iniciando actualización del panel de gastos  _actualizar_panel_gastos - main.py:4075")
        hoy = datetime.date.today()
        gastos_hoy = self.sistema.obtener_gastos_fecha(hoy)
        print(f"[DEBUG] Gastos encontrados para actualizar: {len(gastos_hoy)}  _actualizar_panel_gastos - main.py:4078")
        
        # Actualizar lista visual de gastos
        if hasattr(self, 'inner_frame_gastos'):
            self._actualizar_lista_gastos()
            print("[DEBUG] Lista visual de gastos actualizada - main.py:4083")
        ...
        if hasattr(self, 'lbl_total_gastos'):
            ...
            print(f"[DEBUG] Label de total actualizado: {total_text}  _actualizar_panel_gastos - main.py:4090")
        else:
            print("[DEBUG] ERROR: lbl_total_gastos no existe  _actualizar_panel_gastos - main.py:4092")
...
def aplicar_estilo_moderno_combobox(combo):
    ...
    try:
        ...
        # Fallback si hay problemas con el estilo
        print(f"[DEBUG] Error aplicando estilo a combobox: {e} - main.py:5632")
        combo.configure(font=("Montserrat", 10))
...
def aplicar_estilo_moderno_treeview(tree):
    try:
        ...
        print(f"[DEBUG] Error aplicando estilo a treeview: {e} - main.py:5677")
...
def agregar_icono_a_boton(boton, ruta_icono, tamaño=(24, 24)):
    ...
    try:
        ...
        print(f"[DEBUG] Buscando icono en: {icono_path} - main.py:5767")
        
        if not os.path.exists(icono_path):
            print(f"[DEBUG] ERROR: Icono no encontrado: {icono_path} - main.py:5770")
            return False
            
        # Cargar y redimensionar el ícono
        icono_img = Image.open(icono_path).convert("RGBA")
        print(f"[DEBUG] OK: Imagen cargada: {icono_img.size} - main.py:5775")
        ...
        icono_resized = icono_img.resize(tamaño, resample_filter)
        icono_tk = ImageTk.PhotoImage(icono_resized)
        print(f"[DEBUG] OK: Imagen redimensionada a: {tamaño} - main.py:5788")
        ...
        print(f"[DEBUG] OK: Icono agregado exitosamente: {os.path.basename(ruta_icono)} - main.py:5798")
        return True
        
    except Exception as e:
        print(f"[DEBUG] ERROR: Error agregando icono {ruta_icono}: {e} - main.py:5802")
        return False
...
def configurar_scroll_mouse(canvas, scrollbar=None):
    ...
    print(f"[DEBUG] Scroll con rueda del mouse configurado para canvas: {canvas} - main.py:5881")
...
class SistemaGestion:
    ...
    def agregar_gasto(self, monto: float, motivo: str, fecha: datetime.date, usuario: str = None):
        """Agrega un nuevo gasto"""
        print(f"[DEBUG] SistemaGestion.agregar_gasto llamado: monto={monto}, motivo='{motivo}', fecha={fecha}, usuario='{usuario}'  agregar_gasto - main.py:6063")
        gasto = Gasto(monto, motivo, fecha, usuario)
        self.gastos.append(gasto)
        print(f"[DEBUG] Gasto agregado. Total gastos en memoria: {len(self.gastos)}  agregar_gasto - main.py:6066")
        self.guardar_gastos()
        print("[DEBUG] Gastos guardados en archivo  agregar_gasto - main.py:6068")
        return True

    def obtener_gastos_fecha(self, fecha: datetime.date):
        """Obtiene gastos de una fecha específica"""
        gastos_fecha = [g for g in self.gastos if g.fecha == fecha]
        print(f"[DEBUG] obtener_gastos_fecha para {fecha}: encontrados {len(gastos_fecha)} gastos de {len(self.gastos)} totales  obtener_gastos_fecha - main.py:6074")
        return gastos_fecha
...
class AppPilchero(tk.Tk):
    ...
    def mostrar_venta(self):
        print("[DEBUG] mostrar_venta() llamado  restaurado - main.py:6263")
        self.limpiar_pantalla()
        self._colocar_logo(pantalla_principal=False)
        self._chip_volver(self.mostrar_menu_principal)
        self._pantalla_venta(self.canvas_bg)
    ...
    def mostrar_ventas_dia(self):
        print("[DEBUG] mostrar_ventas_dia() llamado  restaurado - main.py:6270")
        self.limpiar_pantalla()
        self._colocar_logo(pantalla_principal=False)
        self._chip_volver(self.mostrar_menu_principal)
        self._pantalla_ventas_dia(self.canvas_bg)
    def mostrar_actualizar_precio(self):
        print("[DEBUG] mostrar_actualizar_precio() redirigido a Inventario - main.py:6276")
        # Compatibilidad hacia atrás: redirige al Inventario para modificar productos y precios
        self.mostrar_inventario()
    def __init__(self, sistema, session: SessionManager = None):
        print("[DEBUG] Iniciando AppPilchero.__init__ - main.py:6280")
        super().__init__()
        self.sistema = sistema
        self.session = session
        self.title("KONTROL+ - Software de gestión By Alen.iA")
        ...
        print("[DEBUG] Ventana principal configurada como completamente responsiva - main.py:6299")
        print("[DEBUG] Llamando a crear_widgets() desde __init__ - main.py:6300")
        self.crear_widgets()
    ...
    def _configurar_ventana_responsiva(self):
        ...
        print(f"[DEBUG] Ventana configurada para PANTALLA COMPLETA PROFESIONAL: {initial_width}x{initial_height} en pantalla {self.screen_width}x{self.screen_height} - main.py:6332")
        print("[DEBUG] Teclas disponibles: F11 o Alt+Enter para maximizar/restaurar - main.py:6333")
    ...
    def _toggle_fullscreen(self, event=None):
        ...
        if current_state == 'normal':
            ...
            print(f"[DEBUG] PANTALLA COMPLETA TOTAL (100%): {self.screen_width}x{self.screen_height} - main.py:6354")
        else:
            # Restaurar ventana normal (98% de pantalla como antes)
            self.overrideredirect(False)  # Restaurar bordes y barra de título
            self.state('normal')
            ...
            print(f"[DEBUG] Ventana restaurada a modo normal: {normal_width}x{normal_height} - main.py:6373")
    ...
    def _on_window_resize(self, event):
        ...
        if event.widget == self:
            ...
            print(f"[DEBUG] Ventana redimensionada: {event.width}x{event.height} - main.py:6391")
    ...
    def crear_widgets(self):
        print("[DEBUG] Entrando en crear_widgets() - main.py:6516")
    ...
    def _colocar_logo(self, pantalla_principal=True):
        ...
        if pantalla_principal:
            ...
            try:
                ...
                print(f"[DEBUG] Error cargando logo principal: {e}  Ruta: {logo_path} - main.py:6579")
                self.logo_canvas_id = self.canvas_bg.create_text(dims['center_x'], 40, text="[LOGO]", font=("Orbitron", 32, "bold"), fill=COLOR_CIAN, anchor="n")
        else:
            # PANTALLAS SECUNDARIAS: Usar 7.PNG responsivo
            self._colocar_logo_secundarias()
    ...
    def _colocar_logo_secundarias(self):
        ...
        try:
            ...
            if os.path.exists(logo_path):
                ...
                # Fallback si no encuentra el archivo
                print(f"[DEBUG] Logo 7.png no encontrado en: {logo_path} - main.py:6631")
                self.logo_canvas_id = self.canvas_bg.create_text(
                    dims['center_x'], int(dims['height'] * 0.02),
                    text="ALEN.IA", 
                    font=("Orbitron", int(dims['width'] * 0.02), "bold"),  # Tamaño de fuente responsivo
            ...
            print(f"[INFO] Error al cargar logo 7.PNG en pantalla secundaria: {e} - main.py:6641")
            # Fallback texto
            dims = self.get_responsive_dimensions()
            self.logo_canvas_id = self.canvas_bg.create_text(
                dims['center_x'], int(dims['height'] * 0.02), 
    ...
    def _colocar_logo_panel_ia(self):
        ...
        try:
            ...
            if os.path.exists(logo_path):
                ...
                # Fallback si no encuentra el archivo
                print(f"[DEBUG] Logo ALENRESULTADOS.png no encontrado en: {logo_path} - main.py:6698")
                self.logo_canvas_id = self.canvas_bg.create_text(
                    dims['center_x'], int(dims['height'] * 0.025),
                    text="ALEN.IA", 
                    font=("Orbitron", int(dims['width'] * 0.025), "bold"),  # Tamaño responsivo
            ...
            # Fallback: usar texto si hay error
            print(f"[DEBUG] Error cargando ALENRESULTADOS.png: {e} - main.py:6709")
            dims = self.get_responsive_dimensions()
            self.logo_canvas_id = self.canvas_bg.create_text(
                dims['center_x'], int(dims['height'] * 0.025), 
                text="ALENIA RESULTADOS", 
            ...
            print(f"[DEBUG] Error cargando logo Panel IA: {e} - main.py:6720")
            # Fallback texto si no se puede cargar la imagen
            self.logo_canvas_id = self.canvas_bg.create_text(640, 60, text="ALENIA RESULTADOS", font=("Montserrat", 18, "bold"), fill="#00a316", anchor="center")
    ...
    # Métodos stub para evitar errores si no existen
    def mostrar_inventario(self): # type: ignore
        print("[DEBUG] mostrar_inventario() llamado - main.py:6733")
        if not self.require_role(["admin"]):
            return
        self.limpiar_pantalla()
        self._colocar_logo(pantalla_principal=False)
    ...
    def limpiar_pantalla(self):
        """Limpia COMPLETAMENTE todos los widgets y elementos de la pantalla - VERSIÓN OPTIMIZADA"""
        print("[DEBUG] Iniciando limpieza completa de pantalla - main.py:6744")
        
        # 1. Eliminar TODOS los widgets/items registrados en pantalla_widgets
        pantalla_widgets = getattr(self, 'pantalla_widgets', [])
        print(f"[DEBUG] Eliminando {len(pantalla_widgets)} widgets/items de pantalla - main.py:6748")
        ...
        for item in pantalla_widgets:
            try:
                ...
                print(f"[DEBUG] Error eliminando item: {e} - main.py:6768")
        
        # Reset de la lista
        self.pantalla_widgets = []
        
        print(f"[DEBUG] Eliminados: {widgets_eliminados} widgets, {items_canvas_eliminados} canvas items - main.py:6773")
        
        # 2. ELIMINAR TODOS los elementos del canvas (excepto gradiente de fondo)
        try:
            canvas_items = self.canvas_bg.find_all()
            print(f"[DEBUG] Encontrados {len(canvas_items)} elementos totales en canvas - main.py:6778")
            elementos_eliminados = 0
            for item in canvas_items:
                try:
                    # Conservar SOLO elementos con tag "fondo" o "gradient_bg"
                    ...
                    print(f"[DEBUG] Error eliminando item {item}: {e} - main.py:6788")
            print(f"[DEBUG] Eliminados {elementos_eliminados} elementos adicionales del canvas - main.py:6789")
        except Exception as e:
            print(f"[DEBUG] Error en limpieza de canvas: {e} - main.py:6791")
        ...
        print("[DEBUG] Limpieza de pantalla COMPLETADA - main.py:6814")

    def mostrar_menu_principal(self):
        print("[DEBUG] mostrar_menu_principal() llamado - main.py:6817")
        self.limpiar_pantalla()
        self._colocar_logo(pantalla_principal=True)
        ...
        for i, (txt, cmd, tooltip, icono_path) in enumerate(btns_data):
            ...
            icono_agregado = agregar_icono_a_boton(b, icono_path, tamaño=(icono_size, icono_size))
            if icono_agregado:
                print(f"[DEBUG] OK: Icono agregado exitosamente al boton - main.py:6856")
            else:
                print(f"[DEBUG] WARNING: No se pudo cargar el icono para el boton - main.py:6858")
    ...
    def mostrar_menu_secundario(self):
        print("[DEBUG] mostrar_menu_secundario() llamado - main.py:6886")
        self.limpiar_pantalla()
        self._colocar_logo(pantalla_principal=False)
        self._chip_logout()
    ...
    def mostrar_centro_ia(self):
        """Centro de Inteligencia Artificial - Versión Optimizada Visual"""
        print("[DEBUG] mostrar_centro_ia() OPTIMIZADO VISUAL llamado - main.py:7054")
        self.limpiar_pantalla()
    ...
    def mostrar_cierre_caja(self):
        print("[DEBUG] mostrar_cierre_caja() llamado - main.py:7150")
        self.limpiar_pantalla()
        self._colocar_logo(pantalla_principal=False)
        self._chip_volver(self.mostrar_menu_principal)
        self._pantalla_cierre_caja(self.canvas_bg)
    ...
    def mostrar_alta_producto(self):
        print("[DEBUG] mostrar_alta_producto() llamado - main.py:7157")
        if not self.require_role(["admin"]):
            return
        self.limpiar_pantalla()
        self._colocar_logo(pantalla_principal=False)
    ...
    def _pantalla_venta(self, parent):
        ...
        def on_combobox_select(event):
            ...
            if seleccion and seleccion in productos_dict:
                ...
                # Enfocar el siguiente campo (cantidad)
                ent_cantidad.focus_set()
                print(f"[DEBUG] Producto seleccionado: {seleccion}  on_combobox_select - main.py:7291")
        ...
        def set_precio_venta(event=None):
            """Carga automáticamente el precio cuando se selecciona un producto"""
            seleccion = producto_var.get().strip()
            print(f"[DEBUG] set_precio_venta llamado para: '{seleccion}'  set_precio_venta - main.py:7508")
            ...
            if seleccion in productos_dict:
                producto = productos_dict[seleccion]
                print(f"[DEBUG] Producto encontrado: {producto.marca} {producto.descripcion}  Stock: {producto.cantidad}  set_precio_venta - main.py:7516")
                ...
                if producto.oferta and producto.oferta.get('tipo'):
                    print(f"[DEBUG] Oferta encontrada: {producto.oferta}  set_precio_venta - main.py:7532")
                    if producto.oferta['tipo'] == 'porcentaje':
                        descuento = float(producto.oferta['valor'])
                        precio_final = producto.precio_venta * (1 - descuento / 100)
                        mensaje_oferta = f" ({descuento}% OFF)"
                ...
                print(f"[DEBUG] Precio cargado: {precio_mostrar}{mensaje_oferta}  set_precio_venta - main.py:7551")
            else:
                print(f"[DEBUG] Producto no encontrado en diccionario  set_precio_venta - main.py:7553")
                precio_var.set("")
    ...
    def _crear_panel_gastos(self):
        """Crea el panel de gastos del día"""
        print("[DEBUG] Iniciando creación del panel de gastos  _crear_panel_gastos - main.py:7888")
        widgets = []
        hoy = datetime.date.today()
        gastos_hoy = self.sistema.obtener_gastos_fecha(hoy)
        print(f"[DEBUG] Gastos encontrados para hoy ({hoy}): {len(gastos_hoy)} gastos  _crear_panel_gastos - main.py:7892")
    ...
    def _agregar_gasto_dia(self):
        ...
        try:
            ...
            messagebox.showerror("Error", f"Error inesperado al agregar gasto: {str(e)}")
            print(f"[DEBUG] Error en _agregar_gasto_dia: {e} - main.py:8053")

    def _actualizar_lista_gastos(self):
        """Actualiza la lista visual de gastos con formato vertical"""
        print("[DEBUG] Actualizando lista visual de gastos - main.py:8057")
    ...
    def _actualizar_panel_gastos(self):
        """Actualiza la información del panel de gastos"""
        print("[DEBUG] Iniciando actualización del panel de gastos  _actualizar_panel_gastos - main.py:8098")
        hoy = datetime.date.today()
        gastos_hoy = self.sistema.obtener_gastos_fecha(hoy)
        print(f"[DEBUG] Gastos encontrados para actualizar: {len(gastos_hoy)}  _actualizar_panel_gastos - main.py:8101")
        
        # Actualizar lista visual de gastos
        if hasattr(self, 'inner_frame_gastos'):
            self._actualizar_lista_gastos()
            print("[DEBUG] Lista visual de gastos actualizada - main.py:8106")
        ...
        if hasattr(self, 'lbl_total_gastos'):
            total_text = f"Total Gastos del Día: {self.formato_moneda(total_gastos)}"
            self.lbl_total_gastos.config(text=total_text)
            print(f"[DEBUG] Label de total actualizado: {total_text}  _actualizar_panel_gastos - main.py:8113")
        else:
            print("[DEBUG] ERROR: lbl_total_gastos no existe  _actualizar_panel_gastos - main.py:8115")
    ...
    def mostrar_reportes(self):
        ...
        print("[DEBUG] mostrar_reportes() llamado - main.py:9537")
        self.limpiar_pantalla()
        self._colocar_logo(pantalla_principal=False)
        self._chip_volver(self.mostrar_menu_secundario)
        self._chip_logout()
    ...
    def _pantalla_alta_producto(self, parent):
        ...
        print("[DEBUG] Pantalla de alta de producto creada dentro de la ventana principal - main.py:10828")
    ...
    def _pantalla_inventario(self, parent):
        ...
        def modificar_producto():
            ...
            if not seleccion:
                ...
                print("[DEBUG] No hay selección en el Treeview para modificar. - main.py:11076")
                return
            # Obtener datos del producto seleccionado
            item = tree.item(seleccion[0])
            valores = item['values']
            print(f"[DEBUG] Valores seleccionados para modificar: {valores} - main.py:11081")
            if len(valores) < 4:
                messagebox.showerror("Error", "No se pudieron obtener los datos del producto seleccionado.")
                print("[DEBUG] Faltan datos en la fila seleccionada del Treeview. - main.py:11084")
                return
            ...
            if producto:
                ...
                print(f"[DEBUG] Producto encontrado para modificar: {datos} - main.py:11092")
                ...
                print(f"[DEBUG] No se encontró el producto en el sistema: {marca}, {descripcion}, {color}, {talle} - main.py:11096")
    ...
    def _pantalla_modificar_producto(self, datos):
        ...
        print("[DEBUG] Pantalla de modificar producto creada idéntica a agregar producto - main.py:11538")

    def mostrar_centro_ia(self):
        """Centro unificado de todas las funciones de Inteligencia Artificial - Versión Optimizada"""
        print("[DEBUG] mostrar_centro_ia() llamado  OPTIMIZADO - main.py:11542")
        self.limpiar_pantalla()
        # Usar logo especial para Panel IA (ALENRESULTADOS.png)
        if hasattr(self, 'logo_canvas_id') and self.logo_canvas_id:
            self.canvas_bg.delete(self.logo_canvas_id)
    ...
    def mostrar_crear_ofertas(self):
        ...
        print("[DEBUG] mostrar_crear_ofertas() llamado  NEW - main.py:11631")
        if not self.require_role(["admin"]):
            return
        self.limpiar_pantalla()
        self._colocar_logo(pantalla_principal=False)
    ...
    def _mostrar_dashboard_ia(self):
        ...
        titulo_dashboard = tk.Label(self.frame_contenido_ia, 
                                   ...
                                   bg="#1a3d75", 
                                   fg="#00E5FF")
        titulo_dashboard.place(x=600, y=20, anchor="center")
        ...
        frame_alertas.place(x=50, y=40, width=260, height=100)
        
        # Sombra sutil para alertas
        shadow_alertas = tk.Frame(self.frame_contenido_ia, bg="#010205", relief="flat", bd=0)
        shadow_alertas.place(x=52, y=42, width=260, height=100)
        ...
        frame_estrella.place(x=320, y=40, width=260, height=100)
        
        # Sombra para productos estrella
        shadow_estrella = tk.Frame(self.frame_contenido_ia, bg="#010205", relief="flat", bd=0)
        shadow_estrella.place(x=322, y=42, width=260, height=100)
        self.frame_contenido_ia.update()
        frame_estrella.lift()
        ...
        frame_metricas.place(x=630, y=40, width=260, height=100)
        
        # Sombra para métricas
        shadow_metricas = tk.Frame(self.frame_contenido_ia, bg="#010205", relief="flat", bd=0)
        shadow_metricas.place(x=632, y=42, width=260, height=100)
        self.frame_contenido_ia.update()
        frame_metricas.lift()
        ...
        frame_ia_status.place(x=900, y=40, width=260, height=100)
        
        # Sombra para estado IA
        shadow_ia_status = tk.Frame(self.frame_contenido_ia, bg="#010205", relief="flat", bd=0)
        shadow_ia_status.place(x=902, y=42, width=260, height=100)
        self.frame_contenido_ia.update()
        ...
        frame_tabla.place(x=20, y=160, width=1160, height=320)
        ...
        tabla_frame.pack(fill="both", expand=True, padx=0, pady=(0,0))
    ...
    def _mostrar_reposicion_ia(self):
        ...
        frame_tabla.place(x=20, y=105, width=1160, height=375)
    ...
    def _mostrar_precios_ia(self):
        ...
        frame_resumen.place(x=20, y=35, width=1160, height=70)
        
        # Sombra para el resumen
        shadow_resumen = tk.Frame(self.frame_contenido_ia, bg="#0f172a", relief="flat", bd=0)
        shadow_resumen.place(x=22, y=62, width=1160, height=80)
        self.frame_contenido_ia.update()
        frame_resumen.lift()
        ...
        frame_tabla = tk.Frame(self.frame_contenido_ia, bg="#1e293b", relief="raised", bd=2)
        frame_tabla.place(x=20, y=115, width=1160, height=365)
        ...
        for producto in productos_analizados:
            try:
                ...
                print(f"[DEBUG] Error en análisis de precios para {producto.descripcion}: {e} - main.py:12639")
                continue
    ...
    def _mostrar_analisis_ia(self):
        ...
        frame_marcas.place(x=20, y=35, width=280, height=110)
        
        # Sombra para marcas
        shadow_marcas = tk.Frame(self.frame_contenido_ia, bg="#4f46e5", relief="flat", bd=0)
        shadow_marcas.place(x=22, y=37, width=280, height=110)
        self.frame_contenido_ia.update()
        frame_marcas.lift()
        ...
        frame_criticos.place(x=320, y=35, width=280, height=110)
        
        # Sombra para críticos
        shadow_criticos = tk.Frame(self.frame_contenido_ia, bg="#b91c1c", relief="flat", bd=0)
        shadow_criticos.place(x=322, y=37, width=280, height=110)
        self.frame_contenido_ia.update()
        frame_criticos.lift()
        ...
        frame_metricas_ia.place(x=620, y=35, width=280, height=110)
        
        # Sombra para métricas IA
        shadow_metricas_ia = tk.Frame(self.frame_contenido_ia, bg="#047857", relief="flat", bd=0)
        shadow_metricas_ia.place(x=622, y=37, width=280, height=110)
        self.frame_contenido_ia.update()
        ...
        frame_estadisticas.place(x=920, y=35, width=260, height=110)
        
        # Sombra para estadísticas
        shadow_estadisticas = tk.Frame(self.frame_contenido_ia, bg="#6d28d9", relief="flat", bd=0)
        shadow_estadisticas.place(x=922, y=37, width=260, height=110)
        self.frame_contenido_ia.update()
        ...
        frame_tabla_analisis.place(x=20, y=155, width=1160, height=325)
        ...
        for producto in productos_analizar:
            try:
                ...
                print(f"[DEBUG] Error en análisis detallado para {producto.descripcion}: {e} - main.py:12931")
                continue
    ...
    def _calcular_sugerencias_ia(self, dias_analisis, umbral_stock):
        ...
        for producto in productos:
            try:
                ...
                print(f"[DEBUG] Error calculando sugerencia para {producto.descripcion}: {e} - main.py:13043")
                continue
    ...
    def _chip_volver(self, on_volver, x=None, y=None):
        ...
        print(f"[DEBUG] Botón VOLVER responsivo creado en ({x}, {y}) tamaño {btn_width}x{btn_height} - main.py:13131")
...
if __name__ == "__main__":
    ...
    print("[DEBUG] Iniciando flujo de autenticación - main.py:13653")
    auth = AuthManager()
    ...
    while True:
        ...
        if auth.is_first_run():
            ...
            if not created:
                print("[INFO] Onboarding cancelado. Saliendo… - main.py:13662")
                break
            logged_username = created
        else:
            logged = run_login_ui(auth)
            if not logged:
                print("[INFO] Login cancelado. Saliendo… - main.py:13668")
                break
            logged_username = logged

        print("[DEBUG] Usuario autenticado: - main.py:13672", logged_username)
        ...
        print("[DEBUG] Creando instancia de SistemaGestion...  postauth - main.py:13686")
        sistema = SistemaGestion()
        print("[DEBUG] SistemaGestion creado. Creando AppPilchero...  postauth - main.py:13688")
        app = AppPilchero(sistema, session=session)
        print("[DEBUG] AppPilchero creado. Ejecutando mainloop...  postauth - main.py:13690")
        app.mainloop()
        print("[DEBUG] mainloop finalizado  postauth - main.py:13692")
